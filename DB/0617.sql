...
CREATE TABLE `ingredient` (
  ...
  `ingredient_value` int DEFAULT NULL,
  PRIMARY KEY (`recipe_id`,`ingredient_name`),
  CONSTRAINT `ingredient_recipe_FK` FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`recipe_id`)
...
-- Dump completed on 2025-06-17 21:13:00
