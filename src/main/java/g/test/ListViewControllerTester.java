...
public class ListViewControllerTester extends Application {
    @Override
    public void start(Stage primaryStage) {
        try {
            // 检查FXML文件是否存在
            URL fxmlUrl = getClass().getResource("/g/ListView.fxml");
            if (fxmlUrl == null) {
                showError("FXML文件未找到", "无法找到/g/ListView.fxml文件");
                return;
            }
            ...
            primaryStage.setTitle("List View Tester");
